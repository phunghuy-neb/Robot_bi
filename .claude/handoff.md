...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/life_skills_exam.json` — Kỹ năng sống, 6 papers / 42 questions (subject='life_skills'; comp_level set for hsg_*). An toàn (lạc/người lạ/113-114-115), giao tiếp, EQ, quản lý thời gian/tài chính, tư duy phản biện, kỹ năng nhóm/lãnh đạo… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 190 papers / 1376 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 17 môn xong. Còn lại nếu còn quota: music, art, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
