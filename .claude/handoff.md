...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/health_exam.json` — Dinh dưỡng & Sức khỏe, 6 papers / 42 questions (subject='health'; comp_level set for hsg_*). Vệ sinh/nước/ngủ → nhóm chất dinh dưỡng, vitamin/khoáng, BMI, sơ cứu, vắc-xin, bệnh không lây… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 184 papers / 1334 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 16 môn xong. Còn lại nếu còn quota: life_skills, music, art, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
