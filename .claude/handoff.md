...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/economics_exam.json` — Kinh tế học, 6 papers / 42 questions (subject='economics'; comp_level set for hsg_*). Tiền/tiết kiệm/chi tiêu → cung-cầu, lạm phát, GDP, thuế, tỷ giá, chính sách tài khóa/tiền tệ, phát triển bền vững… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 178 papers / 1292 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 15 môn xong. Còn lại nếu còn quota: health, life_skills, music, art, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
