...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/informatics_exam.json` — Tin học, 6 papers / 42 questions (subject='informatics'; comp_level set for hsg_*). Phần cứng/phần mềm, nhị phân, byte/bit, thuật toán, biến/mảng/đệ quy, IP/HTTP, AI, mã hóa… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 160 papers / 1166 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 12 môn xong. Còn lại nếu còn quota: programming, logic, economics, health, life_skills, music, art, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
