...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - **NEXT STEP**: do the next core subject deeply — Tiếng Việt/Ngữ văn OR Tiếng Anh (entrance lớp 6/10 + HSG levels). Ask the user which subject if unspecified; default order = Tiếng Việt → Ngữ văn → Tiếng Anh.
