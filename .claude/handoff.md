...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/art_exam.json` — Mỹ thuật, 6 papers / 42 questions (subject='art'; comp_level set for hsg_*). Màu cơ bản/pha màu, màu nóng-lạnh/bổ túc, phối cảnh, tỉ lệ vàng, trường phái (Ấn tượng/Lập thể/Siêu thực), danh họa VN & thế giới, tranh dân gian/sơn mài/lụa… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 202 papers / 1460 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 19 môn xong. Còn lại nếu còn quota: chinese, japanese, korean (3 ngoại ngữ). Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
