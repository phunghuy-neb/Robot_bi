...
- 2026-06-24: **Learning Hub Phase 2 — content packs + batch AI generation** (branch `003-web-search-integration`):
  ...
  - **NOTE**: missing subjects from the planned catalog not yet packed: `informatics`, `toeic_sw`, and the HSG/exam-track variants — these are produced via the batch-generate pipeline in a later pass (needs LLM keys or more authoring). Curriculum blueprint already lists them.
