...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/music_exam.json` — Âm nhạc, 6 papers / 42 questions (subject='music'; comp_level set for hsg_*). Nốt nhạc, khuông/khóa, nhịp, dấu hóa, hợp âm, quãng tám/ngũ cung, nhạc cụ, di sản (quan họ/ca trù/cồng chiêng/nhã nhạc)… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 196 papers / 1418 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 18 môn xong. Còn lại nếu còn quota: art, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
