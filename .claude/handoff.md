...
- **Learning Hub Phase 3 — HSG/exam packs (strategy: one subject deep at a time):**
  ...
  - DONE (uncommitted, 2026-06-24): `resources/learning/civics_exam.json` — GDCD, 6 papers / 42 questions (subject='civics'; comp_level set for hsg_*). Đạo đức (trung thực, tiết kiệm, biết ơn) → quyền/nghĩa vụ công dân, Hiến pháp/pháp luật, bầu cử 18/ứng cử 21, nhân quyền vs quyền công dân… Validated: 0 bad answers, unique paper_ids. Aggregate now: 24 subjects / 154 papers / 1124 questions / 0 invalid. **Ready to commit.**
  - **NEXT STEP (đang chạy tự động sau 07:15)**: 7 môn lõi/KHTN-KHXH xong (Toán, Văn, Việt, Anh, Khoa học, Lý, Hóa, Sinh, Sử, Địa, GDCD). Các môn còn lại nếu còn quota: informatics, programming, music, art, economics, health, life_skills, logic, chinese, japanese, korean. Cùng pattern. Helper ở scratchpad (`build_exam_common.py`).
